...
class ADE20KSegmentation(SegmentationDataset):
    ...
    def __init__(self, root='/home/qwe123/.ms/datasets/ade', split='test', mode=None, transform=None, **kwargs):
        super(ADE20KSegmentation, self).__init__(root, split, mode, transform, **kwargs)
        self.BASE_DIR = 'ADEChallengeData2016'
    ...
    def _mask_transform(self, mask):
        mask = Tensor(np.array(mask).astype('int32') - 1)
        mask = P.Cast()(mask, mindspore.int64)
        return mask
