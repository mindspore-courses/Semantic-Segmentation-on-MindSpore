...
_TARGET_DIR = os.path.expanduser('/home/qwe123/awesome-semantic-segmentation-pytorch-master/datasets/voc')
...
if __name__ == '__main__':
    ...
    # make symlink
    makedirs(os.path.expanduser('/home/qwe123/awesome-semantic-segmentation-pytorch-master/datasets'))
